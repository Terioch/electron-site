...
const Nav: React.FC<Props> = () => {
	...
	return (
		<nav className="flex flex-col elevation-3">
			...
			<section className="flex justify-between items-center py-3 px-4 md:px-12">
				...
				<Link href="/shop">
					<button className="border rounded-lg bg-blue-600 py-2 px-4 text-gray-50">
						Shop
					</button>
				</Link>
			</section>
